...
class MainWindowController(QMainWindow):
    ...
    def _setup_websocket_signals(self) -> None:
        ...
        self.websocket_client.connection_established.connect(self._on_connection_established)
        self.websocket_client.connection_status_changed.connect(self._on_connection_status_changed)
    ...
    def _on_connection_status_changed(self, is_connected: bool) -> None:
        ...
        if is_connected:
            self.status_label.setText(f"✅ Connected to {self.backend_config.host}:{self.backend_config.port} - Ready for streaming")
            self.status_label.setStyleSheet("color: green; font-weight: bold;")
            self.send_button.setEnabled(True)
        else:
            self.status_label.setText(f"❌ Disconnected from {self.backend_config.host}:{self.backend_config.port} - Reconnecting...")
